...
const schema = z.object({
  ...
  N8N_ZENDA_SEND_URL: z.string().url().optional().or(z.literal('')),
  N8N_WOOLRICH_SEND_URL: z.string().url().optional().or(z.literal('')),
  N8N_MUNDO_CREATIVO_SEND_URL: z.string().url().optional().or(z.literal('')),
  N8N_INTEC_SEND_URL: z.string().url().optional().or(z.literal('')),
  ...
  WHATSAPP_ZENDA_ACCESS_TOKEN: z.string().optional(),
  WHATSAPP_WOOLRICH_ACCESS_TOKEN: z.string().optional(),
  WHATSAPP_MUNDO_CREATIVO_ACCESS_TOKEN: z.string().optional(),
  WHATSAPP_INTEC_ACCESS_TOKEN: z.string().optional(),
